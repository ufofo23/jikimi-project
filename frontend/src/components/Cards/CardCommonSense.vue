<template>
  <div
    class="bg-green-300 w-64 h-96 m-8 static rounded-lg"
    @click="detail(currentCommonSenseNo)"
  >
    <div
      class="bg-white w-64 h-96 hover:-m-2 absolute rounded-lg shadow-lg hover:shadow-2xl transition-all duration-150 ease-out hover:ease-in"
    >
      <h1 class="m-4 text-2xl font-bold">오늘의 토막 상식 🏡</h1>
      ...
      <img
        ...
        alt="card1"
        class="card-image absolute bottom-4 right-4"
      />
    </div>
  </div>
</template>
